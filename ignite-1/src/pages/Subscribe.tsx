...
export function Subscribe() {
    ...
    return(
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className=" flex items-center justify-between mt-20 mx-auto">   
                <div className="max-w-[640px] ml-2 px-2">
                    <Logo />
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        ...
                        <input className="bg-gray-900 rounded px-5 h-14" type="email" placeholder="Digete seu e-mail" 
                                onChange={event => setEmail(event.target.value)}
                        />

                        <button className="uppercase bg-green-500 py-4 rounded font-bold text-sm hover:bg-green-900 transition-colors disabled::opacity-50"
                                type="submit"
                                disabled = {loading}  >  
